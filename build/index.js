 ...
 */
class WebPubSubJsonProtocolImpl {
    constructor() {
        /**
...
class WebSocketClientImpl {
    ...
    onclose(fn) {
        this.socket.onclose = (event) => fn(event.code, event.reason);
    }
    onerror(fn) {
        this.socket.onerror = (event) => fn(event);
    }
    onmessage(fn) {
...
class WebPubSubClient {
     ...
     */
    sendEvent(eventName, content, dataType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._operationExecuteWithRetry(() => this._sendEventAttempt(eventName, content, dataType, options));
        });
    }
    _sendEventAttempt(eventName, content, dataType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const fireAndForget = (_a = options === null || options === void 0 ? void 0 : options.fireAndForget) !== null && _a !== void 0 ? _a : false;
            if (!fireAndForget) {
                return yield this._sendMessageWithAckId((id) => {
                    return {
                        kind: "sendEvent",
                        dataType: dataType,
                        data: content,
                ...
                }, options === null || options === void 0 ? void 0 : options.ackId);
            }
            const message = {
                kind: "sendEvent",
                dataType: dataType,
            ...
            yield this._sendMessage(message);
     ...
     */
    joinGroup(groupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._operationExecuteWithRetry(() => this._joinGroupAttempt(groupName, options));
        });
    }
    _joinGroupAttempt(groupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const group = this._getOrAddGroup(groupName);
            const result = yield this._joinGroupCore(groupName, options);
            group.isJoined = true;
            return result;
        });
    }
    _joinGroupCore(groupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._sendMessageWithAckId((id) => {
                return {
                    group: groupName,
     ...
     */
    leaveGroup(groupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._operationExecuteWithRetry(() => this._leaveGroupAttempt(groupName, options));
        });
    }
    _leaveGroupAttempt(groupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const group = this._getOrAddGroup(groupName);
            const result = yield this._sendMessageWithAckId((id) => {
                return {
                    group: groupName,
                    ackId: id,
                    kind: "leaveGroup",
     ...
     * @param options - The options
     */
    sendToGroup(groupName, content, dataType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._operationExecuteWithRetry(() => this._sendToGroupAttempt(groupName, content, dataType, options));
        });
    }
    _sendToGroupAttempt(groupName, content, dataType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const fireAndForget = (_a = options === null || options === void 0 ? void 0 : options.fireAndForget) !== null && _a !== void 0 ? _a : false;
    ...
    _connectCore(uri) {
        ...
        return new Promise((resolve, reject) => {
            ...
            client.onmessage((data) => {
                ...
                const handleConnectedMessage = (message) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!this._isInitialConnected) {
                        ...
                        if (this._options.autoRejoinGroups) {
                            ...
                            this._groupMap.forEach((g) => {
                                if (g.isJoined) {
                                    groupPromises.push((() => __awaiter(this, void 0, void 0, function* () {
                                        try {
                                            yield this._joinGroupCore(g.name);
                                        }
                                        catch (err) {
    ...
    _handleConnectionCloseAndNoRecovery() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._options.autoReconnect) {
                yield this._autoReconnect();
            }
            else {
                yield this._handleConnectionStopped();
            }
        });
    }
    _autoReconnect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                while (!this._isStopping) {
                    try {
                        yield this._startFromRestarting();
                        isSuccess = true;
                        break;
                    }
                    catch (err) {
    ...
    _sendMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._wsClient.send(payload);
        });
    }
    _sendMessageWithAckId(messageProvider, ackId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (ackId == null) {
    ...
    _handleConnectionClose() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                while (this._isStopping) {
                    try {
                        yield this._connectCore.call(this, recoveryUri);
                        recovered = true;
                        return;
                    }
                    catch (_a) {
    ...
    _operationExecuteWithRetry(inner) {
        return __awaiter(this, void 0, void 0, function* () {
            let retryAttempt = 0;
            while (true) {
                try {
                    return yield inner.call(this);
                }
                catch (err) {
                    retryAttempt++;
...
exports.WebPubSubJsonProtocol = WebPubSubJsonProtocol;
exports.WebPubSubJsonReliableProtocol = WebPubSubJsonReliableProtocol;
